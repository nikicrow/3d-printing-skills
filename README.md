...
| 🔩 **U-bracket** | A U-shaped bracket/hook: circular 16 mm bend, two 50 mm legs, constant 2.5 mm wall, shallow grip ridges all down the outer face. Swept band — no booleans — and prints flat with no supports. | [`u_bracket.py`](u_bracket.py) |
...
# U-bracket (defaults: 16 mm bend, 50 mm legs, 2.5 mm wall, 7 mm wide)
